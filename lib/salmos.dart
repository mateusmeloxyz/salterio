class Salmo {
  ...
  const Salmo(this.number, this.title, this.subtitle, this.description, this.enabled);
}

List<Salmo> salmos = [
  const Salmo(1,
    "1. BEM AVENTURADO É O VARÃO",
    "",
  """
...
Porém acima destes está Deus, 
Eis que habita nos mais altos céus.
Dos tais, do alto, Ele zombará;
